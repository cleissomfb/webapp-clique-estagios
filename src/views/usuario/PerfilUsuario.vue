<template>
  <section class="section mt-5 mb-3 containerImagem">
    <div class="container">
      <form class="col-md-12 ml-auto mr-auto">
        ...
        <b-row>
          ...
          <b-col md="4">
            <b-form-group id="rg" label="RG:" label-for="rg">
              ...
              <span
                class="text-danger text-center"
                v-if="submitted && !$v.usuario.informacoes.pessoais.rg.required"
              >
                Digite o RG.
              </span>
            </b-form-group>
        ...
        <b-row class="mt-3">
          ...
          <b-col md="7">
            <b-form-group id="endereco" label="Endereço:" label-for="endereco">
              <b-form-input
                id="endereco"
                type="text"
                readonly
          ...
          <b-col md="2">
            <b-form-group id="numero" label="Número:" label-for="numero">
              <b-form-input
                ...
                :class="{
                  'is-invalid':
                    submitted && $v.usuario.informacoes.endereco.numero.$error,
                }"
              ...
              <div
                class="text-danger text-center"
                v-if="
                  submitted && !$v.usuario.informacoes.endereco.numero.required
                "
              >
                Digite o número.
              </div>
        ...
        <b-row>
          ...
          <b-col md="6">
            <b-form-group id="facebook" label="Facebook:" label-for="facebook">
              <b-form-input
                id="facebook"
                type="text"
          ...
          <b-col md="6">
            <b-form-group id="linkedin" label="Linkedin:" label-for="linkedin">
              <b-form-input
                id="linkedin"
                type="text"
            ...
            <b-row>
              ...
              <b-col class="mt-4 descrVagas" md="3" cols="5">
                <div class="correcao-buttons">
                  ...
                  >
                    <b-icon icon="plus" aria-hidden="true"></b-icon> </b-button
                  ><b-button
            ...
            >
              <b-row>
                ...
                <b-col md="6">
                  ...
                  ><br />
                  <b-form-checkbox value="Persuação">Persuação</b-form-checkbox
                  ><br />
        ...
        <b-row>
          ...
          <b-col md="4">
            <b-form-group id="semestre" label="Semestre:" label-for="nsemestre">
              <b-form-input
                id="semestre"
                type="text"
                v-model="semestre"
            ...
            >
              <b-row>
                <b-col md="12"
                  ...
                  ><b-form-checkbox value="noite">Noite</b-form-checkbox></b-col
                >
              </b-row>
        ...
        <b-row v-if="vivenciaAnterior == true && primeiraExperiencia == false">
          <b-col md="12">
        ...
        <hr v-if="vivenciaAnterior == true && primeiraExperiencia == false" />
        <b-row v-if="vivenciaAnterior == true && primeiraExperiencia == false">
          <b-col md="12">
        ...
        <b-row>
            ...
            <b-form-checkbox-group v-model="selectedInformatica" class="mb-3">
              <b-row>
                <b-col md="4"
                  ...
                  ><br />
                  <b-form-checkbox value="Access">Access</b-form-checkbox><br />
                  <b-form-checkbox value="Corel Draw"
                    >Corel Draw</b-form-checkbox
                  ><br />
                  <b-form-checkbox value="Photoshop">Photoshop</b-form-checkbox
                  ><br />
                  ...
                  ><br />
                  <b-form-checkbox value="Delphi">Delphi</b-form-checkbox><br />
                </b-col>
                <b-col md="4">
                  ...
                  <b-form-checkbox value="Oracle">Oracle</b-form-checkbox><br />
                  ...
                  ><br />
                  <b-form-checkbox value="Fireworks">Fireworks</b-form-checkbox
                  ><br />
                  <b-form-checkbox value="Promob">Promob</b-form-checkbox><br />
                ...
                <b-col md="4">
                  ...
                  ><br />
                  <b-form-checkbox value="3D studio">3D studio</b-form-checkbox
                  ><br />
                  ...
                  <b-form-checkbox value="JQuery">JQuery</b-form-checkbox><br />
          ...
          <b-col md="12">
            <b-form-checkbox-group v-model="selectedOutros">
              <b-row>
                <b-col md="6"
                  ><b-form-checkbox value="Carro">Carro</b-form-checkbox><br />
                  <b-form-checkbox value="CNH A">CNH A</b-form-checkbox><br />
                  <b-form-checkbox value="CNH AB">CNH AB</b-form-checkbox><br />
                  <b-form-checkbox value="CNH B">CNH B</b-form-checkbox><br />
                  <b-form-checkbox value="COREN">COREN</b-form-checkbox><br />
                </b-col>
                <b-col md="6">
                  <b-form-checkbox value="Digitação">Digitação</b-form-checkbox
                  ><br />
                  ...
                  ><br />
                  <b-form-checkbox value="Recreação">Recreação</b-form-checkbox
                  ><br />
                </b-col>
              </b-row>
            </b-form-checkbox-group>
    ...
    if (this.usuario.informacoes.educacao.length > 0) {
      ...
      this.usuario.informacoes.educacao.forEach((educacao) => {
        ...
        if (iterator > 0) {
          ...
          if (
            educacao.mesFormatura &&
            educacao.anoFormatura &&
            educacao.numeroMatricula
          ) {
