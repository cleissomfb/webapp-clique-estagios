<template>
  <div>
    <NavbarPaginaInicial />
    <div class="section mt-3 mb-5 containerImagem">
      <div class="container">
        <form class="col-md-12 ml-auto mr-auto">
            ...
            <b-col md="4">
              ...
              >
                <b-form-input
                  ...
                  type="password"
                  :class="{
                    'is-invalid': submitted && $v.usuario.confirmarSenha.$error,
                  }"
            ...
            <b-col md="6">
              <b-form-group id="nome" label="Nome:" label-for="nome">
                <b-form-input
                  ...
                  :class="{
                    'is-invalid':
                      submitted && $v.usuario.informacoes.pessoais.nome.$error,
                  }"
                ...
                <span
                  class="text-danger text-center"
                  v-if="
                    submitted && !$v.usuario.informacoes.pessoais.nome.required
                  "
                >
                  Digite o nome.
                </span>
            ...
            <b-col md="3">
              <b-form-group id="sexo" label="Sexo:" label-for="sexo">
                <b-form-select
                  ...
                  :class="{
                    'is-invalid':
                      submitted && $v.usuario.informacoes.pessoais.sexo.$error,
                  }"
                >
                  <template #first>
                  ...
                  >
                  <b-form-select-option value="O">Outros</b-form-select-option>
                </b-form-select>
                <span
                  class="text-danger text-center"
                  v-if="
                    submitted && !$v.usuario.informacoes.pessoais.sexo.required
                  "
                >
                  Selecione o sexo.
                </span>
            ...
            <b-col md="4">
              <b-form-group id="email" label="E-mail:" label-for="email">
                <b-form-input
                  ...
                  :class="{
                    'is-invalid':
                      submitted && $v.usuario.informacoes.pessoais.email.$error,
                  }"
                  type="text"
                ></b-form-input>
                <span
                  class="text-danger text-center"
                  v-if="
                    submitted && !$v.usuario.informacoes.pessoais.email.required
                  "
                >
                  Digite o e-mail.
                </span>
            ...
            <b-col md="4">
              <b-form-group id="empresa" label="Empresa:" label-for="empresa">
                <b-form-input
                  id="empresa"
                  type="text"
                  v-model="experienciaVivenciaAnterior1.empresaVivenciaAnterior"
                ></b-form-input>
              </b-form-group>
            </b-col>
            ...
            <b-col md="4">
              <b-form-group id="empresa" label="Empresa:" label-for="empresa">
                <b-form-input
                  id="empresa"
                  type="text"
                  v-model="experienciaVivenciaAnterior2.empresaVivenciaAnterior"
                ></b-form-input>
              </b-form-group>
            </b-col>
          ...
          <b-row>
            ...
            <b-col md="12">
              <b-form-checkbox-group v-model="selectedInformatica" class="mb-3">
                <b-row>
                  <b-col md="4"
                    ><b-form-checkbox value="Word">Word</b-form-checkbox><br />
                    <b-form-checkbox value="Excel">Excel</b-form-checkbox><br />
                    <b-form-checkbox value="Internet">Internet</b-form-checkbox
                    ><br />
                    ...
                    ><br />
                    <b-form-checkbox value="Freehand">Freehand</b-form-checkbox
                    ><br />
                    <b-form-checkbox value="Flash">Flash</b-form-checkbox><br />
                    ...
                    ><br />
                    <b-form-checkbox value="Hardware">Hardware</b-form-checkbox
                    ><br />
                  ...
                  <b-col md="4">
                    ...
                    <b-form-checkbox value="Redes">Redes</b-form-checkbox><br />
                    <b-form-checkbox value="Manutenção de PCs"
                      >Manutenção de PCs</b-form-checkbox
                    ><br />
                    <b-form-checkbox value="Linux">Linux</b-form-checkbox><br />
                    ...
                    ><br />
                    <b-form-checkbox value="Indesign">Indesign</b-form-checkbox
                    ><br />
                    <b-form-checkbox value="Premiere">Premiere</b-form-checkbox
                    ><br />
                    ...
                    ><br />
                    <b-form-checkbox value="Sketchup">Sketchup</b-form-checkbox
                    ><br />
                  </b-col>
                  <b-col md="4">
                    ...
                    ><br />
                    <b-form-checkbox value="Formz">Formz</b-form-checkbox><br />
                    ...
                    ><br />
                    <b-form-checkbox value="Revit">Revit</b-form-checkbox><br />
                    <b-form-checkbox value="MySQL">MySQL</b-form-checkbox><br />
                    <b-form-checkbox value="JQuery">JQuery</b-form-checkbox
                    ><br />
                    <b-form-checkbox value="Parallax">Parallax</b-form-checkbox
                    ><br />
                    <b-form-checkbox value="Bootstrap"
                      >Bootstrap</b-form-checkbox
                    ><br />
                    <b-form-checkbox value="Archicad">Archicad</b-form-checkbox
                    ><br />
              ...
              <b-form-checkbox-group v-model="selectedOutros">
                <b-row>
                  <b-col md="6"
                    ...
                    ><br />
                    <b-form-checkbox value="CNH A">CNH A</b-form-checkbox><br />
                    <b-form-checkbox value="CNH AB">CNH AB</b-form-checkbox
                    ><br />
                    <b-form-checkbox value="CNH B">CNH B</b-form-checkbox><br />
                    <b-form-checkbox value="COREN">COREN</b-form-checkbox><br />
                  </b-col>
                  <b-col md="6">
...
export default {
  ...
  data() {
    return {
      ...
      selectedHabilidades: [],
      optionsHabilidades: [
        { item: "AutoConfiança", name: "AutoConfiança" },
        { item: "Boa Comunicação", name: "Boa Comunicação" },
        { item: "Capacidade de Adaptação", name: "Capacidade de Adaptação" },
        { item: "Capacidade de Análise", name: "Capacidade de Análise" },
        { item: "Capacidade de Liderança", name: "Capacidade de Liderança" },
        { item: "Competitividade", name: "Competitividade" },
        { item: "Compreensão Interpessoal", name: "Compreensão Interpessoal" },
        { item: "Criatividade e Inovação", name: "Criatividade e Inovação" },
        { item: "Espíriro de Equipe", name: "Espíriro de Equipe" },
        { item: "Flexibilidade", name: "Flexibilidade" },
        { item: "Gerenciamento do Tempo", name: "Gerenciamento do Tempo" },
        { item: "Iniciativa", name: "Iniciativa" },
        { item: "Inteligência Emocional", name: "Inteligência Emocional" },
        { item: "Persuação", name: "Persuação" },
        { item: "Resolução de Problemas", name: "Resolução de Problemas" },
        { item: "Visão de Negócio", name: "Visão de Negócio" },
        { item: "Visão no Cliente", name: "Visão no Cliente" },
      ],
      ...
      optionsTurnoEstagio: [
        { item: "manha", name: "Manhã" },
        { item: "tarde", name: "Tarde" },
      ...
      selectedIdiomas: [],
      optionsIdiomas: [
        { item: "Espanhol Fluente", name: "Espanhol Fluente" },
        { item: "Espanhol Básico", name: "Espanhol Básico" },
        { item: "Espanhol Intermediário", name: "Espanhol Intermediário" },
        { item: "Inglês Fluente", name: "Inglês Fluente" },
        { item: "Inglês Básico", name: "Inglês Básico" },
        { item: "Inglês Intermediário", name: "Inglês Intermediário" },
      ],
      ...
      optionsInformatica: [
        ...
        { item: "Internet", name: "Internet" },
        { item: "Power Point", name: "Power Point" },
        { item: "Dreamweaver", name: "Dreamweaver" },
        { item: "Access", name: "Access" },
        { item: "Corel Draw", name: "Corel Draw" },
        { item: "Photoshop", name: "Photoshop" },
        { item: "HTML", name: "HTML" },
        { item: "Autocad 2D", name: "Autocad 2D" },
        { item: "Page Maker", name: "Page Maker" },
        { item: "Freehand", name: "Freehand" },
        { item: "Flash", name: "Flash" },
        { item: "Visual Basic", name: "Visual Basic" },
        { item: "Java", name: "Java" },
        { item: "Web Design", name: "Web Design" },
        { item: "Hardware", name: "Hardware" },
        { item: "Delphi", name: "Delphi" },

        { item: "SQL", name: "SQL" },
        { item: "Redes", name: "Redes" },
        { item: "Manutenção de PCs", name: "Manutenção de PCs" },
        { item: "Linux", name: "Linux" },
        { item: "Banco de Dados", name: "Banco de Dados" },
        { item: "ASP", name: "ASP" },
        { item: "Oracle", name: "Oracle" },
        { item: "Acrobat Reader", name: "Acrobat Reader" },
        { item: "PHP", name: "PHP" },
        { item: "illustrator", name: "illustrator" },
        { item: "Indesign", name: "Indesign" },
        { item: "Premiere", name: "Premiere" },
        { item: "After Effects", name: "After Effects" },
        { item: "Fireworks", name: "Fireworks" },
        { item: "Promob", name: "Promob" },
        { item: "Sketchup", name: "Sketchup" },
        { item: "CSS", name: "CSS" },

        { item: "Vectorworks", name: "Vectorworks" },
        { item: "Formz", name: "Formz" },
        { item: "Render V –Ray", name: "Render V –Ray" },
        { item: "3D studio", name: "3D studio" },
        { item: "Linguagem C", name: "Linguagem C" },
        { item: "Linguagem C++", name: "Linguagem C++" },
        { item: "Linguagem C#", name: "Linguagem C#" },
        { item: "Autocad 3D", name: "Autocad 3D" },
        { item: "Revit", name: "Revit" },
        { item: "MySQL", name: "MySQL" },
        { item: "JQuery", name: "JQuery" },
        { item: "Parallax", name: "Parallax" },
        { item: "Bootstrap", name: "Bootstrap" },
        { item: "Archicad", name: "Archicad" },
        { item: "Javascript", name: "Javascript" },
      ],

      selectedOutros: [],
      optionsOutros: [
        { item: "Carro", name: "Carro" },
        { item: "CNH A", name: "CNH A" },
        { item: "CNH AB", name: "CNH AB" },
        { item: "CNH B", name: "CNH B" },
        { item: "COREN", name: "COREN" },
        { item: "Digitação", name: "Digitação" },
        { item: "Inglês Técnico", name: "Inglês Técnico" },
        { item: "Moto", name: "Moto" },
        { item: "OAB", name: "OAB" },
        { item: "Qualidade Total", name: "Qualidade Total" },
        { item: "Recreação", name: "Recreação" },
      ],
  ...
  methods: {
    ...
    saveCandidato() {
      ...
      usuarioService
        ...
        .then(() => {
          this.infoMsg = "Candidato cadastrado com sucesso!";
    ...
    hideModalCancelarCandidato() {
      this.$bvModal.hide("cancelarCadastroCandidato");
    },
  },
};
</script>
