            ...
            <b-col md="4">
              ...
              >
                <b-form-input
                  ...
                  :class="{
                    'is-invalid': submitted && $v.empresa.confirmarSenha.$error,
                  }"
                ></b-form-input>
                <span
                  class="text-danger text-center"
            ...
            <b-col md="4">
              ...
              >
                <b-form-input
                  ...
                  :class="{
                    'is-invalid':
                      submitted && $v.empresa.informacoes.principais.ie.$error,
                  }"
                ></b-form-input>
                <span
                  class="text-danger text-center"
                  v-if="
                    submitted && !$v.empresa.informacoes.principais.ie.required
                  "
                >
                  Digite a IE.
                </span>
